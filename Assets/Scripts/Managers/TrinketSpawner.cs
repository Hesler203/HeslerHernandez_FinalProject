...
[AlchemySerialize]
public partial class TrinketSpawner : Spawner
{
    [Header("Settings")]
    ...
    new public enum SpawnType { ball, battery, jak }
    ...
    {
        int randomType = Random.Range((int)SpawnType.ball, (int)SpawnType.jak);
    ...
    override protected void SpawnRandomPrefab()
    {
        ...
        GameObject spawnedPrefab = Instantiate(randomPrefab, randomLocation, randomPrefab.transform.rotation, transform);
    }
}